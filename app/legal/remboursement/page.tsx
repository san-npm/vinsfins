...
const content: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  fr: {
    ...
    sections: [
      ...
      { heading: "3. Procédure", body: "Pour initier un retour, contactez-nous à contact@vinsfins.lu en indiquant votre numéro de commande. Nous vous fournirons les instructions de retour. Les frais de retour sont à la charge du client." },
  ...
  en: {
    ...
    sections: [
      ...
      { heading: "3. Procedure", body: "To initiate a return, contact us at contact@vinsfins.lu with your order number. We will provide return instructions. Return shipping costs are borne by the customer." },
