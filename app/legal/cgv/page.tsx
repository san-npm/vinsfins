...
const content: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  fr: {
    ...
    sections: [
      ...
      { heading: "7. Livraison", body: "Livraison disponible au Luxembourg, en France, Belgique et Allemagne. Frais de livraison calculés selon le poids et la destination (dès 7 € au Luxembourg, 12 € en Zone 1 Europe). Retrait en boutique (Click & Collect) gratuit. Délai de livraison estimé : 2 à 5 jours ouvrables." },
  ...
  en: {
    ...
    sections: [
      ...
      { heading: "7. Delivery", body: "Delivery available in Luxembourg, France, Belgium and Germany. Shipping calculated by weight and destination (from €7 in Luxembourg, €12 in Europe Zone 1). In-store pickup (Click & Collect) is free. Estimated delivery: 2-5 business days." },
