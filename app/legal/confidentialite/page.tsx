...
const content: Record<string, { title: string; sections: { heading: string; body: string }[] }> = {
  fr: {
    ...
    sections: [
      { heading: "1. Responsable du traitement", body: "Vins Fins, 18 Rue Münster, L-2160 Luxembourg. Contact : info@vinsfins.lu." },
      ...
      { heading: "6. Sous-traitants", body: "Stripe (paiement), Vercel (hébergement), DPD Luxembourg et Packlink, qui opère la plateforme DPD Web Parcel (livraison). Vos nom, adresse, téléphone et e-mail sont transmis à ces deux derniers uniquement pour acheminer votre colis. Ces prestataires sont conformes au RGPD." },
      { heading: "7. Vos droits", body: "Conformément au RGPD, vous disposez d'un droit d'accès, de rectification, de suppression, de limitation et de portabilité de vos données. Pour exercer ces droits : info@vinsfins.lu." },
  ...
  en: {
    ...
    sections: [
      { heading: "1. Data controller", body: "Vins Fins, 18 Rue Münster, L-2160 Luxembourg. Contact: info@vinsfins.lu." },
      ...
      { heading: "6. Subprocessors", body: "Stripe (payments), Vercel (hosting), DPD Luxembourg and Packlink, which operates the DPD Web Parcel platform (delivery). Your name, address, phone number and email are passed to the latter two solely to carry your parcel. These providers are GDPR compliant." },
      { heading: "7. Your rights", body: "Under GDPR, you have the right to access, rectify, delete, restrict and port your data. To exercise these rights: info@vinsfins.lu." },
